  ...
  return (
    <section className="fixed w-full h-20 shadow-xl z-[100]">
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Image src="/../public/assets/logosa.png" alt="/" width="60" height="60" />
      ...
      <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
        ...
        >
          <div className="flex w-full items-center justify-between">
            <Image src="/../public/assets/logosa.png" alt="/" width="75" height="75" />
            <div
              onClick={handleNav}
              className="rounded-lg shadow-lg shadow-gray-500 p-1 cursor-pointer"
            >
          ...
          <div className="border-b border-gray-300 my-12">
            <p className="w-[85%] md:w-[90%] py-4">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sapiente repudiandae impedit
              placeat vel culpa.{' '}
            </p>
          </div>
          <div className="py-4 flex flex-col">
            ...
            <div className="pt-40">
              <p className="uppercase -tracking-widest text-[#5651e5]">Laten we werken</p>
              <div className="flex items-center justify-between my-4 w-full sm:w-[80%]">
                <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-100 ease-in duration-200">
                  <FaLinkedinIn />
                </div>
                <div className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-100 ease-in duration-200">
                  <FaGithub />
